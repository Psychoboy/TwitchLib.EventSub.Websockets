...
{
    class ChatMessageDeleteHandler : INotificationHandler
    {
        public string SubscriptionType => "channel.chat.message_delete";
        public void Handle(EventSubWebsocketClient client, string jsonString, System.Text.Json.JsonSerializerOptions serializerOptions)
        {
            try
            {
