...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
        ...
        private async ValueTask HandleWelcomeAsync(WebsocketEventSubMetadata metadata, JsonElement payload)
        {
            ...
            await WebsocketConnected.InvokeAsync(this, new WebsocketConnectedArgs { IsRequestedReconnect = _reconnectRequested, KeepAliveTimeout = _keepAliveTimeout }).ConfigureAwait(false);
        }
